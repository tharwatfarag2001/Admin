...
export default class AddEditQuestionToChapter extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  add_question() {
    ...
    if (obj.question_text.trim() == '') {
      ...
      let data = {
        ...
        question_image: obj.question_image == null ? null : '1',
        question_answers: answers,
        question_valid_answer: obj.question_valid_answer,
        question_chapter_id: this.state.chapter_id,
      };
      RNFetchBlob.fetch(
        'POST',
        basic.url + `challenge/add_to_Bank_ques.php`,
        {
  ...
  async edit_question() {
    ...
    if (obj.question_text.trim() == '') {
      ...
      RNFetchBlob.fetch(
        'POST',
        domain + `challenge/edit_ques_testBank.php`,
        {
          Authorization: 'Bearer access-token',
          otherHeader: 'foo',
          'Content-Type': 'multipart/form-data',
